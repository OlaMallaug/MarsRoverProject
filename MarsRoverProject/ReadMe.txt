...
drive off the plateau, this could be added to the code to give warning if rover drive outside the plateau.
...
MarsRoverProjectTest has a few simple unit tests in it that is using the MarsRover class as target.